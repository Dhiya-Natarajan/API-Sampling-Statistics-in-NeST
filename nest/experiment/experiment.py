...
class Experiment:
    ...
    @input_validator
    def require_qdisc_stats(self, interface: BaseInterface, stats="", interval: float = 0.2):
        """
        ...
        interval : float
            Sampling interval in seconds for tc qdisc stats (default 0.2).
            Different interfaces can use different sampling rates.
        """
